        ...
        <div class="relative px-6 lg:px-5">
          <div class="mx-auto lg:w-[989px] py-32 sm:py-48 lg:py-56">
            <div class="lg:text-center">
              <h1 class="text-4xl font-bold tracking-tight text-white sm:text-4xl font-poppins">Experience The Best of Decentralized Gaming <br><span class="gradient-text">Neutron</span> Is Coming.</h1>
