<template>
    <nav class="bg-black bg-opacity-20 border-gray-200 sm:mb-28 mb-16">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="~/assets/images/gap-logo.png" class="h-8" alt="Flowbite Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap font-satoshi text-white"></span>
        </a>
